...
$(document).ready(function(){
    ...
    var $eachSkill = [
        ...
        ["MOUSE MOVE", "circleText_MouseMove.png"],
        ["GLASS MORPHISM", "glassMorphism.png"],
        ["TEST ES6", "test_ES6.png"],
        ["SLIDER_JQUERY", "slider_jquery.png"],
        ["FOR문_JQUERY", "for_jquery.png"],
        ["LOGIN_PHP", "php_login.png"],
        ["HEADER_VUE COMPONENT", "header_vueComponent.png"],
    ]

        //#3. 반복문
    for(v of $skills_arr){
        $("main .box > #skill > ul.skill_bar").append(`
        <li>
            <h3>${v[1]}</h3>
            <span class="progress">
    ...
    $("main .box > #skill > ul.skill_bar li").each(function(index){
        $(this).find(".gage").css("width",`${$skills_arr[index][0]}%`);
    });


    $("main .box > #skill .more").click(function(){
